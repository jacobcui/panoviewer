$(function(){
	...
	$( getjid(floor_imageid) ).attr("src", "/get/scene//fp");
	...
	var sides = [
	    {
		url: img_loc + set_name + '/r' + set_format,
		position: [ -center_distance, 0, 0 ],
		rotation: [ 0, Math.PI / 2, 0 ]
	    },
	    {
		url: img_loc + set_name + '/l' + set_format,
		position: [ center_distance, 0, 0 ],
		rotation: [ 0, -Math.PI / 2, 0 ]
	    },
	    {
		url: img_loc + set_name + '/u' + set_format,
		position: [ 0,  center_distance, 0 ],
		rotation: [ Math.PI / 2, 0, Math.PI ]
	    },
	    {
		url: img_loc + set_name + '/d' + set_format,
		position: [ 0, -center_distance, 0 ],
		rotation: [ - Math.PI / 2, 0, Math.PI ]
	    },
	    {
		url: img_loc + set_name + '/f' + set_format,
		position: [ 0, 0,  center_distance ],
		rotation: [ 0, Math.PI, 0 ]
	    },
	    {
		url: img_loc + set_name + '/b' + set_format,
		position: [ 0, 0, -center_distance ],
		rotation: [ 0, 0, 0 ]
	    }
	];
